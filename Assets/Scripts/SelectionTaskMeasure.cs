...
public class SelectionTaskMeasure : MonoBehaviour
{
    ...
    public void StartOneTask()
    {
        ...
        objectTStartingPos = taskUI.transform.position + taskUI.transform.forward * 5f + taskUI.transform.up * 0.6f; //+ taskUI.transform.forward * 0.5f + taskUI.transform.up * 0.75f;
        targetTStartingPos = taskUI.transform.position + taskUI.transform.right * 5f + taskUI.transform.up * 0.7f;
